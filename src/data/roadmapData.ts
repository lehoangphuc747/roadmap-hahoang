...
const sessionContentMap: { [key: number]: string[] } = {
    ...
    25: ['-(으)ㄹ 수 있다 (1)', '-(으)ㄹ 수 있다 (2)'], // Buổi 25 (04/02) học (으)ㄹ 수 있다 1, 2
    26: ['-(으)니까 (1)', '-(으)니까 (2)'], // Buổi 26 học (으)니까 1, 2
    27: ['Ôn -(으)니까 (2)', '-(으)면'], // Buổi 27: Ôn (으)니까 2, (으)면
    28: ['Ôn -(으)니까 (2)', '-(으)면'], // Buổi 28 (11/02) ôn (으)니까 2, (으)면
    29: ['Ôn tập tổng hợp 62 cấu trúc'], // Buổi 29 (13/02) - 50 câu (30 TN + 20 điền khuyết)
};
